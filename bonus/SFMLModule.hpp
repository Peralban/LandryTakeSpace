...
namespace nts {
    ...
    class SFMLGates {
    public:
        SFMLGates(std::string name, Type type, sf::VideoMode _videoMode, size_t size, int index, size_t allSize);
        ~SFMLGates() = default;
    ...
    public:
        ...
        void createGates(componentAndNameInVector component, Type type, size_t allSize);
        void createOutputGates(allOutputAndNameInVector outputs, Type type, size_t allSize);
        void createInputGates(allInputAndNameInVector inputs, Type type, size_t allSize);
